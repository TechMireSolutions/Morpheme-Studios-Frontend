...
export const projects = [
  ...
  },
  {
    ...
    status: 'Completed',
    cover: img.cafe,
    gallery: [img.cafe, img.retail1, img.interior4],
    excerpt: 'A warm and inviting bakery interior designed to showcase artisanal products.',
    services: ['Interior Design', 'Retail'],
    description: 'Just Baked is a retail concept that emphasizes the warmth of traditional baking through a contemporary material palette of timber and warm lighting.',
  },
  {
    slug: 'residence-42-peachey-lane',
    title: 'Residence – 42 Peachey Lane',
    location: 'London, UK',
    year: '2023',
    category: 'residential',
    type: 'Residential',
    status: 'Completed',
    cover: img.villa,
    gallery: [img.villa, img.interior1, img.house2],
    excerpt: 'A modern residential project in London focusing on spatial efficiency and natural light.',
    services: ['Architecture', 'Interior Design'],
    description: 'A bespoke residential intervention in London that maximizes living space through clever structural solutions and a restrained material palette.',
  },
  {
    slug: 'residence-159-christchurch-avenue',
    title: 'Residence 159 Christchurch Avenue',
    location: 'London, UK',
    year: '2023',
    category: 'residential',
    type: 'Residential',
    status: 'Completed',
    cover: img.house4,
    gallery: [img.house4, img.interior3, img.house5],
    excerpt: 'Contemporary living in a historic London neighborhood.',
    services: ['Architecture', 'Interior Design'],
    description: 'This residence balances modern design requirements with the contextual character of Christchurch Avenue, featuring open-plan living and high-end finishes.',
  },
  {
    slug: 'residence-157-christchurch-avenue',
    title: 'Residence 157 Christchurch Avenue',
    location: 'London, UK',
    year: '2023',
    category: 'residential',
    type: 'Residential',
    status: 'Completed',
    cover: img.house5,
    gallery: [img.house5, img.interior5, img.house2],
    excerpt: 'A sibling project to 159, exploring variations on modern urban living.',
    services: ['Architecture', 'Interior Design'],
    description: 'Part of a series of residential developments, 157 Christchurch Avenue offers a unique take on the contemporary family home in London.',
  },
  {
    slug: 'dip-shop-outlets',
    title: 'Dip Shop – Outlets',
    location: 'Karachi, Pakistan',
    year: '2021',
    category: 'retail',
    type: 'Retail',
    status: 'Completed',
    cover: img.retail1,
    gallery: [img.retail1, img.retail2, img.cafe],
    excerpt: 'A bold, scalable retail concept for a specialized dip shop.',
    services: ['Retail Design', 'Branding'],
    description: 'Dip Shop outlets are designed for high-impact visual presence and operational efficiency, featuring a modular counter system and vibrant brand colors.',
  },
  {
    slug: 'bunify',
    title: 'BUNIFY',
    ...
    services: ['Interior Design', 'Retail'],
    description: 'BUNIFY brings a fresh perspective to fast-casual dining with its industrial-chic interior and focused lighting that highlights the food preparation process.',
  },
]
